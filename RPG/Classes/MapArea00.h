...
namespace RPG
{
	...
	private:
		...
		void NPC0Dialogue1Option0Event(const GPL::Control& control,const int option_selected_index);


		void GatewayEvent(GPL::MapObject& map_object_base,GPL::MapObject& map_object_interacting);


		void DoorEvent(GPL::MapObject& map_object_base,GPL::MapObject& map_object_interacting);
	...
	public:
		//Construtor
		MapArea00(const float hero_position_x,const float hero_position_y,const bool hero_teleporting,const HeroMapChangeDirection hero_entering_map_direction);
	};
}
